                            ...
                            <form class="requires-validation" novalidate>
                                ...
                                <div class="col-md-12 mt-3">
                                    ...
                                    <input type="radio" class="btn-check" name="gender" id="secret" autocomplete="off"
                                        required>
                                    <label class="btn btn-sm btn-outline-secondary" for="secret">Prefiero no decirlo</label>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="" id="invalidCheck"
                                        required>
                                    <label class="form-check-label">Yo confirmo que mis datos son validos y correctos.</label>
